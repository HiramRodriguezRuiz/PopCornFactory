...
class CatalogoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adapterM: PeliculaAdapter? = PeliculaAdapter(this, movies)
        var adapterS: PeliculaAdapter? = PeliculaAdapter(this, series)
    ...
    private fun cargarShows(){
        movies.add(Pelicula("Big Hero 6",R.drawable.bighero6, R.drawable.bighero6, "When a devastating event befalls the city of San Fransokyo and catapults Hiro into the midst of danger, he turns to Baymax and his close friends adrenaline junkie Go Go Tomago, neatnik Wasabi, chemistry whiz Honey Lemon and fanboy Fred. Determined to uncover the mystery, Hiro transforms his friends into a band of high-tech heroes called ‘Big Hero 6.’", arrayListOf<Cliente>()))
    ...
    class PeliculaAdapter : BaseAdapter, ListAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var image: ImageView = view.findViewById(R.id.iv_pelicula)
            var title: TextView = view.findViewById(R.id.tv_nombre_pelicula)
            ...
            image.setOnClickListener {
                ...
                intent.putExtra("numeroAsientos",(20-pelicula.numeroAsientos.size))
